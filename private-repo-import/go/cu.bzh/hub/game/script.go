...
`
	...
	// 0.1.19+
	// --------------------------------------------------------------
	defaultScript_0_1_19plus = `Modules = {
    sfx = "sfx",
    controls = "controls",
}

local jumpStrength = 100
local playerSpeed = 50

if Players.Max > 1 then
    -- Importing "multi" is all you need to see other players.
    -- It can also be used to sync other objects and actions.
    require("multi")
end
