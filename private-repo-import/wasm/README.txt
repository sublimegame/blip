...
The SDK archive is on the particubes-private repo in /wasm, you don't need to download it.
	Currently using: 3.1.69
	Source: https://github.com/emscripten-core/emsdk/tree/3.1.69
...
2) activate the SDK `./emsdk activate [version] --permanent`, this makes that version of Emscripten the default version used on your machine.
...
emsdk activate mingw-7.1.0-64bit --permanent
```
