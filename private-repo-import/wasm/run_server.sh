...
docker run --rm \
-v ${PROJECT_ROOT}/wasm/Particubes/build/output:/editions/latest \
-v /Users/gaetan/projects/voxowl/exe/certs/cu.bzh:/cubzh/certificates \
-e NO_CACHE=1 \
-e SECURE=1 \
-e TLS_CERT_PATH=/cubzh/certificates/cu.bzh.chained.crt \
-e TLS_KEY_PATH=/cubzh/certificates/cu.bzh.key \
-p 1080:80 \
-p 1443:443 \
wasm
